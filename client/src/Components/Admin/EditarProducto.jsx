            ...
            <li key={producto.id}>
              <div className="ordererAdminEdit">
                <div>
                  ...
                  />
                  <TextField
                    className="levelAdminMaterialEditimg"
                    onChange={(e) => {
                  ...
                  <TextField
                    className="levelAdminMaterialEdit"
                    placeholder={`${producto.cantidadDeProducto}`}
                    onChange={(e) => handleChangeEditar(e)}
                    name="cantidadDeProducto"
                    type="number"
                    label={producto.cantidadDeProducto}
                    variant="filled"
                    color="success"
                  />
                  ...
                  <FormControl>
                    ...
                    >
                      ...
                      <MenuItem value="Plantines y Semillas">
                        Plantines y Semillas
                      </MenuItem>
                      <MenuItem value="Composteras">Composteras</MenuItem>
                      <MenuItem value="Insumos y Herramientas para Huertas">
                        Insumos y Herramientas para Huertas
                      </MenuItem>
                      <MenuItem value="Lombrices Rojas Californeanas">
                        Lombrices Rojas Californeanas
                      </MenuItem>
                    </Select>
                  </FormControl>
                  <Button
                    className="adminButtonED"
                    sx={{ margin: "4px", marginLeft: "16px" }}
                    id={producto.id}
